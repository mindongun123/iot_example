  ...
  return (
    <nav className='navbar'>
      ...
      <div className='navbar-item-container'>
        ...
        <Link 
          to="/datasensor" 
          className={`item-link ${activeLink === '/datasensor' ? 'active' : ''}`} 
          onClick={() => handleLinkClick('/datasensor')}
        >
        ...
        <Link 
          to="/history" 
          className={`item-link ${activeLink === '/history' ? 'active' : ''}`} 
        ...
        <Link 
          to="/profile" 
          className={`item-link ${activeLink === '/profile' ? 'active' : ''}`} 
